...
var alreadyWarned = {},
    log, printWarning, welcome;

if (hasConsole) {
    let welcomeIntro = [
        `%cSQUP Ractive, Things may behave differently %c<@version@> %cin debug mode, %cmore...`,
...
export {
    fatal, log, logIfDebug, warn, warnOnce, warnIfDebug, warnOnceIfDebug, welcome
};
